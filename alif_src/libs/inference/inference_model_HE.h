#ifndef INFERENCE_MODEL_HE_H
#define INFERENCE_MODEL_HE_H
...
#include <models_dsp_preprocessing/model_orbw_19_Q_HE_vela.h>
#else
#include <models_librosa/model_orbw_19_Q_HE_vela.h>
...
#ifdef USE_MODELS_DSP_PREPROCESSING
#include <models_dsp_preprocessing/model_us_Q_HE_vela.h>
#else
#include <models_librosa/model_us_Q_HE_vela.h>
#endif // USE_MODELS_DSP_PREPROCESSING
